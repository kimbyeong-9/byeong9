...
import ScheduleOverview from '../components/travel-schedule-detail/ScheduleOverview';
import TravelInfoSection from '../components/travel-schedule-detail/TravelInfoSection';
import DayScheduleSection from '../components/travel-schedule-detail/DayScheduleSection';
import ActionButtons from '../components/travel-schedule-detail/ActionButtons';
  ...
  return (
    <TravelScheduleDetailPage>
      ...
      <DetailContainer>
        ...
        <ScheduleOverview
          schedule={schedule}
          authorUploadCount={authorUploadCount}
          isLiked={isLiked}
          isUserSchedule={isUserSchedule}
          onLike={handleLike}
          onAuthorClick={handleAuthorClick}
        />

        {/* 여행 상세 정보 */}
        <TravelInfoSection schedule={schedule} />
